-- ═══════════════════════════════════════════════════════════════════
-- 🎁 COMPLETE GIFTS TABLE FIX V2 - حل شامل ونهائي (مُصلح)
-- ═══════════════════════════════════════════════════════════════════
...
BEGIN
    ...
    RAISE NOTICE '✅ Step 1: Policies deleted';
END $$;
...
-- تفعيل الـ Replica Identity Full للحصول على البيانات القديمة في الـ Realtime
